...
export default function Footer() {
  ...
  return (
    <footer className="bg-navy-500 text-white relative overflow-hidden">
      <CloudPatternOverlay color="white" opacity={0.04} />
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          {/* Follow Us */}
          <div>
            <h4 className="font-display font-bold text-lg mb-4">{t('footer.followUs')}</h4>
            <div className="flex gap-4">
              <a
                href="https://www.instagram.com/newhongkong.mx"
                target="_blank"
              ...
              <a
                href="https://www.facebook.com/newHKpuebla"
                target="_blank"
                rel="noopener noreferrer"
                className="text-white/60 hover:text-white transition-colors"
                aria-label="Facebook"
          ...
          <div>
            ...
            <a
              href="https://wa.me/522216534481"
              target="_blank"
              rel="noopener noreferrer"
              className="text-white/60 hover:text-whatsapp transition-colors flex items-center gap-2 text-sm"
            >
